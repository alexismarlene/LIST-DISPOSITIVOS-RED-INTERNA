...
choice=input("do you want use token forced??? y/n ")
if choice=="n" or choice=="N":
    accessToken=input("enter your access token")
    accessToken="Bearer "+accessToken
else:
    accessToken="Bearer YzQ4NTk1YmMtYTU2ZS00YTk5LTlhZGUtNDFiYTc5YzgwYzJmOWM4M2QzNzEtM2U4_P0A1_49d1e4bd-2a1c-4119-b74e-be561ec00408"
...
if messageCounter==0:
    print("sorry but you haven message"+messageText)
else:
    print("number of message found  "+messageCounter)
print("thaks for use this program and think API + PYTHON!!")
